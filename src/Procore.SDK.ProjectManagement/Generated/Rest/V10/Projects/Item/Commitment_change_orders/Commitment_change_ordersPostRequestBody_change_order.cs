...
namespace Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders
{
    ...
    public partial class Commitment_change_ordersPostRequestBody_change_order : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Unique identifier for a change order batch.</summary>
        public int? BatchId { get; set; }
        /// <summary>Unique identifier for the change reason.</summary>
        public int? ChangeOrderChangeReasonId { get; set; }
...
#nullable enable
        public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id? CustomFieldCustomFieldDefinitionId { get; set; }
#nullable restore
#else
        public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id CustomFieldCustomFieldDefinitionId { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>Whether or not the Change Order is executed</summary>
...
#nullable restore
        ...
        /// <summary>Number of the Change Order</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>Whether or not the Commitment Change Order is private</summary>
        public bool? Private { get; set; }
        /// <summary>Unique identifier for the received from entity.</summary>
...
#nullable restore
        ...
        /// <summary>Whether a signature will be required for this Change Order</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order"/> and sets the default values.
        /// </summary>
        public Commitment_change_ordersPostRequestBody_change_order()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "change_order_change_reason_id", n => { ChangeOrderChangeReasonId = n.GetIntValue(); } },
                { "contract_id", n => { ContractId = n.GetIntValue(); } },
                { "custom_field_%{custom_field_definition_id}", n => { CustomFieldCustomFieldDefinitionId = n.GetObjectValue<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id>(global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteIntValue("change_order_change_reason_id", ChangeOrderChangeReasonId);
            writer.WriteIntValue("contract_id", ContractId);
            writer.WriteObjectValue<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id>("custom_field_%{custom_field_definition_id}", CustomFieldCustomFieldDefinitionId);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_orders.Commitment_change_ordersPostRequestBody_change_order.Commitment_change_ordersPostRequestBody_change_order_custom_field_Custom_field_definition_id();
