...
namespace Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches
{
    ...
    public partial class Commitment_change_order_batchesPostRequestBody_change_order_batch : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch.Commitment_change_order_batchesPostRequestBody_change_order_batch_custom_field_Custom_field_definition_id? CustomFieldCustomFieldDefinitionId { get; set; }
#nullable restore
#else
        public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch.Commitment_change_order_batchesPostRequestBody_change_order_batch_custom_field_Custom_field_definition_id CustomFieldCustomFieldDefinitionId { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch"/> and sets the default values.
        /// </summary>
        public Commitment_change_order_batchesPostRequestBody_change_order_batch()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch();
        }
        /// <summary>
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Commitment_change_order_batchesPostRequestBody_change_order_batch_custom_field_Custom_field_definition_id : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch.Commitment_change_order_batchesPostRequestBody_change_order_batch_custom_field_Custom_field_definition_id"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch.Commitment_change_order_batchesPostRequestBody_change_order_batch_custom_field_Custom_field_definition_id CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Commitment_change_order_batches.Commitment_change_order_batchesPostRequestBody_change_order_batch.Commitment_change_order_batchesPostRequestBody_change_order_batch_custom_field_Custom_field_definition_id();
