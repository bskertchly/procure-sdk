...
namespace Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds
{
    ...
    public partial class Manual_holds : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public List<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds_attachments>? Attachments { get; set; }
#nullable restore
#else
        public List<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds_attachments> Attachments { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds"/> and sets the default values.
        /// </summary>
        public Manual_holds()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds_attachments>(global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds_attachments.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Payment_readiness.Manual_holds.Manual_holds_attachments>("attachments", Attachments);
