...
namespace Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Forms
{
    ...
    public partial class FormsPostRequestBody_form : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string Description { get; set; }
#endif
        /// <summary>Form&apos;s Fillable PDF. Either `fillable_pdf_prostore_file_id` or `fillable_pdf_upload_id` must be present.</summary>
        public int? FillablePdfProstoreFileId { get; set; }
        /// <summary>The specified Upload is saved as the Form&apos;s Fillable PDF. Either `fillable_pdf_prostore_file_id` or `fillable_pdf_upload_id` must be present.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string FillablePdfUploadId { get; set; }
#endif
        /// <summary>ID of the Form Template that the Form is made from</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Forms.FormsPostRequestBody_form"/> and sets the default values.
        /// </summary>
        public FormsPostRequestBody_form()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Forms.FormsPostRequestBody_form"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Forms.FormsPostRequestBody_form CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Forms.FormsPostRequestBody_form();
        }
        /// <summary>
