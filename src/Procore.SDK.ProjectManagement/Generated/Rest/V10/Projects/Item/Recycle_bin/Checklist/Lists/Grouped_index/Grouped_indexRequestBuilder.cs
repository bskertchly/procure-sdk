...
namespace Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index
{
    ...
    public partial class Grouped_indexRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Grouped_indexRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rest/v1.0/projects/{%2Did}/recycle_bin/checklist/lists/grouped_index{?filters%5Bclosed_at%5D*,filters%5Bclosed_by_id%5D,filters%5Bcreated_at%5D*,filters%5Bdue_at%5D*,filters%5Bid%5D,filters%5Binspection_date%5D*,filters%5Binspection_type_id%5D,filters%5Binspector_id%5D,filters%5Blist_template_id%5D,filters%5Blocation_id%5D,filters%5Bmanaged_equipment_id%5D*,filters%5Bpoint_of_contact_id%5D,filters%5Bquery%5D*,filters%5Bresponsible_contractor_id%5D,filters%5Bspec_section_id%5D,filters%5Bstatus%5D*,filters%5Btrade_id%5D*,filters%5Bupdated_at%5D*,group_by*,page*,per_page*,sort*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_index&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_index401Error">When receiving a 401 status code</exception>
        /// <exception cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_index403Error">When receiving a 403 status code</exception>
...
#nullable restore
        ...
        public async Task<List<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_index>> GetAsync(Action<RequestConfiguration<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_indexRequestBuilder.Grouped_indexRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "401", global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_index401Error.CreateFromDiscriminatorValue },
                { "403", global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_index403Error.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_indexRequestBuilder.Grouped_indexRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_indexRequestBuilder.Grouped_indexRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_indexRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_indexRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.Grouped_indexRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists Recycled Checklist (Inspections) in a specified Project grouped by a specified attribute. By default the Checklists are grouped by template.See [Filtering on List Actions](https://developers.procore.com/documentation/filtering-on-list-actions) for information on using the filtering capabilities provided by this endpoint.
        /// </summary>
...
#nullable restore
            ...
            public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.GetGroup_byQueryParameterType? GroupBy { get; set; }
            ...
            [QueryParameter("sort")]
            public global::Procore.SDK.ProjectManagement.Rest.V10.Projects.Item.Recycle_bin.Checklist.Lists.Grouped_index.GetSortQueryParameterType? Sort { get; set; }
        }
    }
}
