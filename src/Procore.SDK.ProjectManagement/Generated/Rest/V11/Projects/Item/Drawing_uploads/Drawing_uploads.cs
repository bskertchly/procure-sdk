...
namespace Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads
{
    ...
    public partial class Drawing_uploads : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>Drawing Log Imports (Only included in &apos;with_drawing_log_imports&apos; view)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_drawing_log_imports>? DrawingLogImports { get; set; }
#nullable restore
#else
        public List<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_drawing_log_imports> DrawingLogImports { get; set; }
#endif
...
#nullable restore
        ...
        public global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_status? Status { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads"/> and sets the default values.
        /// </summary>
        public Drawing_uploads()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "drawing_log_imports", n => { DrawingLogImports = n.GetCollectionOfObjectValues<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_drawing_log_imports>(global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_drawing_log_imports.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_drawing_log_imports>("drawing_log_imports", DrawingLogImports);
            ...
            writer.WriteEnumValue<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Drawing_uploads.Drawing_uploads_status>("status", Status);
