...
namespace Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics
{
    ...
    public partial class Meeting_topicsPostRequestBody_meeting_topic : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic_priority? Priority { get; set; }
        /// <summary>The Status of the Meeting Topic</summary>
        public global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic"/> and sets the default values.
        /// </summary>
        public Meeting_topicsPostRequestBody_meeting_topic()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "priority", n => { Priority = n.GetEnumValue<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic_priority>(); } },
                { "status", n => { Status = n.GetEnumValue<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic_priority>("priority", Priority);
            writer.WriteEnumValue<global::Procore.SDK.ProjectManagement.Rest.V11.Projects.Item.Meeting_topics.Meeting_topicsPostRequestBody_meeting_topic_status>("status", Status);
