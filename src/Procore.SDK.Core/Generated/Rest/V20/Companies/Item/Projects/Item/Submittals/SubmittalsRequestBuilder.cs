...
namespace Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsGetResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals401Error">When receiving a 401 status code</exception>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals403Error">When receiving a 403 status code</exception>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals404Error">When receiving a 404 status code</exception>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals422Error">When receiving a 422 status code</exception>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals4XXError">When receiving a 4XX status code</exception>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals500Error">When receiving a 500 status code</exception>
        /// <exception cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals5XXError">When receiving a 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsGetResponse?> GetAsync(Action<RequestConfiguration<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder.SubmittalsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsGetResponse> GetAsync(Action<RequestConfiguration<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder.SubmittalsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "401", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals401Error.CreateFromDiscriminatorValue },
                { "403", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals403Error.CreateFromDiscriminatorValue },
                { "404", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals404Error.CreateFromDiscriminatorValue },
                { "422", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals422Error.CreateFromDiscriminatorValue },
                { "4XX", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals4XXError.CreateFromDiscriminatorValue },
                { "500", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals500Error.CreateFromDiscriminatorValue },
                { "5XX", global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.Submittals5XXError.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsGetResponse>(requestInfo, global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Return a list of all Submittals.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder.SubmittalsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder.SubmittalsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.SubmittalsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Return a list of all Submittals.
        /// </summary>
...
#nullable restore
            ...
            [QueryParameter("sort")]
            public global::Procore.SDK.Core.Rest.V20.Companies.Item.Projects.Item.Submittals.GetSortQueryParameterType? Sort { get; set; }
        }
    }
}
