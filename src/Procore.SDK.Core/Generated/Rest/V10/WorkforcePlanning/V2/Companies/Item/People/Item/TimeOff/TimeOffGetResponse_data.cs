...
namespace Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff
{
    ...
    public partial class TimeOffGetResponse_data : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_instances>? Instances { get; set; }
#nullable restore
#else
        public List<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_instances> Instances { get; set; }
#endif
...
#nullable restore
        ...
        public global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_repeat? Repeat { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data"/> and sets the default values.
        /// </summary>
        public TimeOffGetResponse_data()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "instances", n => { Instances = n.GetCollectionOfObjectValues<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_instances>(global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_instances.CreateFromDiscriminatorValue)?.AsList(); } },
                { "is_paid", n => { IsPaid = n.GetBoolValue(); } },
                { "person_id", n => { PersonId = n.GetGuidValue(); } },
                { "reason", n => { Reason = n.GetStringValue(); } },
                { "repeat", n => { Repeat = n.GetEnumValue<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_repeat>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_instances>("instances", Instances);
            writer.WriteBoolValue("is_paid", IsPaid);
            writer.WriteGuidValue("person_id", PersonId);
            writer.WriteStringValue("reason", Reason);
            writer.WriteEnumValue<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.Item.TimeOff.TimeOffGetResponse_data_repeat>("repeat", Repeat);
