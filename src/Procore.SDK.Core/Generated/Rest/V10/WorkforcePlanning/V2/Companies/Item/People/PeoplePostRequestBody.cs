...
#nullable restore
        ...
        /// <summary>The email that the Person will log in with. Required if `is_user` is true.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string FirstName { get; set; }
#endif
        /// <summary>Array of UUIDs representing the Groups this Person belongs to. Can be empty if the Person is an Admin.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_language? Language { get; set; }
...
#nullable restore
        ...
        public string LastName { get; set; }
#endif
        /// <summary>If `true`, the Person will be created with all user properties but will not receive an invite until triggered manually by an Admin.</summary>
        ...
        /// <summary>Password for logging in. If not provided, an email will be sent to the user to set their password. Must be at least 8 characters with one uppercase, one lowercase, and one number.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string Password { get; set; }
#endif
        /// <summary>UUID of the Permission Level assigned to the Person.</summary>
        public Guid? PermissionLevelId { get; set; }
        /// <summary>The Person&apos;s phone number, including country and area code. Must be unique among all registered People. **Note:** Pass `null` or exclude the field if the Person should not have a phone number.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_status? Status { get; set; }
        /// <summary>List of tags applied to the Person. Tags can require expiration dates.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_tag_instances>? TagInstances { get; set; }
#nullable restore
#else
        public List<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_tag_instances> TagInstances { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "language", n => { Language = n.GetEnumValue<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_language>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_status>(); } },
                { "tag_instances", n => { TagInstances = n.GetCollectionOfObjectValues<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_tag_instances>(global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_tag_instances.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_language>("language", Language);
            ...
            writer.WriteEnumValue<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_status>("status", Status);
            writer.WriteCollectionOfObjectValues<global::Procore.SDK.Core.Rest.V10.WorkforcePlanning.V2.Companies.Item.People.PeoplePostRequestBody_tag_instances>("tag_instances", TagInstances);
