...
namespace Procore.SDK.QualitySafety.Rest.V10.Observations.Items
{
    ...
    public partial class ItemsPostRequestBody_observation : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The ID of the User that will be assigned to the Observation Item</summary>
        ...
        /// <summary>The ID of the User creating the Observation Item. Only Observations Admin Users can set the creator</summary>
...
#nullable enable
        public global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id? CustomFieldCustomFieldDefinitionId { get; set; }
#nullable restore
#else
        public global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id CustomFieldCustomFieldDefinitionId { get; set; }
#endif
...
#nullable restore
        ...
        public string Description { get; set; }
#endif
        /// <summary>An array of the User IDs of the Observation Item distribution members</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>The ID of the Location of the Observation Item. `location_id` takes precedence over `mt_location`.</summary>
...
#nullable restore
        ...
        /// <summary>The Privacy status of the Observation Item</summary>
        public bool? Personal { get; set; }
        /// <summary>The Priority of the Observation Item</summary>
        public global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation_priority? Priority { get; set; }
        /// <summary>The ID of the specification section to set on the Observation.</summary>
        public int? SpecificationSectionId { get; set; }
        /// <summary>The Status of the Observation Item</summary>
        public global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation"/> and sets the default values.
        /// </summary>
        public ItemsPostRequestBody_observation()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "custom_field_%{custom_field_definition_id}", n => { CustomFieldCustomFieldDefinitionId = n.GetObjectValue<global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id>(global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id.CreateFromDiscriminatorValue); } },
                ...
                { "priority", n => { Priority = n.GetEnumValue<global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation_priority>(); } },
                { "specification_section_id", n => { SpecificationSectionId = n.GetIntValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id>("custom_field_%{custom_field_definition_id}", CustomFieldCustomFieldDefinitionId);
            ...
            writer.WriteEnumValue<global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation_priority>("priority", Priority);
            writer.WriteIntValue("specification_section_id", SpecificationSectionId);
            writer.WriteEnumValue<global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation_status>("status", Status);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Procore.SDK.QualitySafety.Rest.V10.Observations.Items.ItemsPostRequestBody_observation.ItemsPostRequestBody_observation_custom_field_Custom_field_definition_id();
